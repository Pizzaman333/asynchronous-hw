...
var _message = require("./js/message");

},{"./js/timer":"flgYy","./js/animations":"hdDUW","./js/game":"gnxQg","./js/message":"j1P9T"}],"flgYy":[function(require,module,exports,__globalThis) {
let count = 0;
const maxMessages = 5;
const interval = 1000;
...
function addMessage() {
    count++;
    messagesDiv.innerHTML += `<div class="message">\u{41F}\u{43E}\u{432}\u{456}\u{434}\u{43E}\u{43C}\u{43B}\u{435}\u{43D}\u{43D}\u{44F} \u{2116}${count}</div>`;
    if (count >= maxMessages) clearInterval(timer);
}
let timer;
...
},{}],"hdDUW":[function(require,module,exports,__globalThis) {
...
function changeSize() {
    ...
    if (scale >= 1.5) isGrowing = false;
    else if (scale <= 0) isGrowing = true;
}
let positionY = 25;
let positionX = 25;
let hasMovedY = false;
...
function changePosY() {
    ...
    if (positionY >= 275) hasMovedY = true;
    else if (positionY <= -10) hasMovedY = false;
    if (positionX >= 350) hasMovedX = true;
    else if (positionX <= -10) hasMovedX = false;
}
let rotation = 0;
...
function changeAngle() {
    ...
    if (rotation >= 200) hasRotated = true;
    else if (rotation <= -200) hasRotated = false;
}
...
},{}],"j1P9T":[function(require,module,exports,__globalThis) {
document.getElementById('startButton').addEventListener('click', ()=>{
    const timeInput = document.getElementById('timeInput').value;
    const message = document.getElementById('message');
    if (timeInput && timeInput > 0) {
        message.textContent = `\u{417}\u{430}\u{447}\u{435}\u{43A}\u{430}\u{439}\u{442}\u{435} ${timeInput} \u{441}\u{435}\u{43A}\u{443}\u{43D}\u{434}...`;
        setTimeout(()=>{
            message.textContent = "\u0427\u0430\u0441 \u0437\u0430\u043A\u0456\u043D\u0447\u0438\u0432\u0441\u044F!";
        }, timeInput * 1000);
    } else message.textContent = "\u0412\u0432\u0435\u0434\u0456\u0442\u044C \u043A\u043E\u0440\u0435\u043A\u0442\u043D\u0438\u0439 \u0447\u0430\u0441.";
});

},{}]},["6BDg4","fILKw"], "fILKw", "parcelRequire7772")

//# sourceMappingURL=asynchronous-hw.1fcc916e.js.map
